...
**RTT (Round Trip Time): 174.023000 milliseconds**  
...
| پکت | جهت | توضیح |
|-----|-----|-------|
| Client Hello | کلاینت ← سرور | کلاینت لیست 20 الگوریتم رمزنگاری پشتیبانی‌شده را برای سرور ارسال کرد |
